...
/**
 * Pre-Trade Checklist (`/workspace/pre-trade-checklist`). Fill this out
 * *before* entering — a plan, not a trade record — so there's a timestamped,
 * honest account of what you intended and why, independent of the outcome.
 * Saves as a Journal entry (kind "plan") or attaches straight to a trade if
 * one's already on the books. Read-only against the account: it only reads
 * the Challenge Tracker's live budgets as a reminder, never blocks anything.
 */
export function PreTradeChecklistPage() {
  ...
  return (
    <PageContainer
      ...
      description="Fill this out before you enter, not after — a timestamped record of what you actually planned, so a later review is honest instead of hindsight-shaped. Nothing here blocks a trade; it's a mirror, not a gate."
    >
