  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Frozen strategy contracts and edge research.',
      ...
      },
      {
        ...
        label: 'Backtesting',
        description: 'Backtests, walk-forward optimization and Monte Carlo.',
    ...
    items: [
      {
        ...
        label: 'Journal',
        description: 'Trade journal and research observation notes.',
      ...
      },
      {
        id: 'operations.audit',
        label: 'Audit',
        description: 'Decision history and reproducibility audit.',
